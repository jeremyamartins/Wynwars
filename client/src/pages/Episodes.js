...
class Episodes extends Component {
  ...
  getEpisode = (e) => {
    ...
    if(episode) {
      ...
      setTimeout(function(){ let element = document.getElementById("epi");
      element.classList.remove("hidden"); }, 500);
  ...
  render(){
    return(
      <>
        ...
        <div id="lsediv">
        <h1>Star Wars</h1>
        <img alt="lightsabers" id="lse" src={ls}></img>
        <h1>Episodes</h1>
        </div>
        <div id="middle">
          ...
          <div id="poster">
          <img src={'./posters/' + this.state.episode.episode_id + ".jpg"}/>
          </div>
          <div id="results">
